...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      useInvertedBackground={false}
      features={[
        { title: "Service rapide", description: "Un personnel réactif et attentif pour que vous profitiez au maximum de votre repas.", media: { imageSrc: "http://img.b2bpic.net/free-photo/fried-chicken-meat-seafood-barbecue-with-vegetables-wooden-skewers-plate-sauce-top-view_1253-954.jpg" }, items: [], reverse: false },
        { title: "Qualité premium", description: "Sélection rigoureuse de produits locaux frais pour des saveurs inégalées.", media: { imageSrc: "http://img.b2bpic.net/free-photo/fresh-harvest-basket-beautifully-presented-outside-market-sale_346278-732.jpg" }, items: [], reverse: true },
        { title: "Ambiance chaleureuse", description: "Un cadre accueillant, parfait pour vos repas en famille ou entre amis.", media: { imageSrc: "http://img.b2bpic.net/free-photo/fresh-fish-white-table_23-2148263876.jpg" }, items: [], reverse: false },
      ]}
  ...
  <div id="products" data-section="products">
      ...
      useInvertedBackground={false}
      products={[
        { id: "1", name: "Tajine de poissons", price: "80 MAD", imageSrc: "http://img.b2bpic.net/free-photo/female-barista-black-shirt-trousers-with-coffee-brown-dried-tea-equipment-ingredients-making-tea-white-wall_140725-11660.jpg" },
        { id: "2", name: "Grillades mixtes", price: "120 MAD", imageSrc: "http://img.b2bpic.net/free-photo/peppermint-tea-glass-ready-drink_1150-38035.jpg" },
        { id: "3", name: "Brochettes de viande", price: "90 MAD", imageSrc: "http://img.b2bpic.net/free-photo/tea-with-lemon-slices_23-2148550450.jpg" },
        { id: "4", name: "Couscous traditionnel", price: "70 MAD", imageSrc: "http://img.b2bpic.net/free-photo/pottery-pan-with-meat-balls-cooked-egg-with-spinach-topped-with-tomato_140725-8663.jpg" },
        { id: "5", name: "Salade marocaine", price: "40 MAD", imageSrc: "http://img.b2bpic.net/free-photo/plate-with-food-near-cup-drink-teapot_23-2148080944.jpg" },
        { id: "6", name: "Thé à la menthe", price: "15 MAD", imageSrc: "http://img.b2bpic.net/free-photo/side-view-stewed-chicken-with-chestnuts-onion-clay-bowl-wooden-table_140725-11485.jpg" },
      ]}
      title="Notre Menu"
  ...
  <div id="pricing" data-section="pricing">
      ...
      useInvertedBackground={false}
      plans={[
        { id: "basic", badge: "Solo", price: "50 MAD", subtitle: "Repas simple et rapide", features: ["Plat du jour", "Boisson incluse"], buttons: [{ text: "Commander" }] },
        { id: "pro", badge: "Duo", price: "150 MAD", subtitle: "Pour un moment convivial", features: ["2 Plats", "Entrées", "Boissons"], buttons: [{ text: "Commander" }] },
        { id: "family", badge: "Famille", price: "350 MAD", subtitle: "Le festin complet", features: ["Sélection de grillades", "Tagine au choix", "Desserts"], buttons: [{ text: "Commander" }] },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      useInvertedBackground={false}
      metrics={[
        { id: "m1", icon: Zap, title: "Clients satisfaits", value: "980+" },
        { id: "m2", icon: ShieldCheck, title: "Années d'expérience", value: "10+" },
        { id: "m3", icon: HeartPulse, title: "Plats servis", value: "50k+" },
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        ...
        { title: "Informations", items: [{ label: "Contact", href: "#contact" }, { label: "Horaires", href: "#" }] },
      ]}
    />
  </div>
      </ReactLenis>
